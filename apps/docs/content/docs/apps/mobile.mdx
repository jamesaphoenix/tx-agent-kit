...
The mobile application is built with [Expo](https://expo.dev/) and React Native. It provides the same core functionality as the web app, including authentication, workspace management, task tracking, and invitations, through a native mobile interface.
