...
- GitHub Actions run `26425929409` passed the prior `Ensure infrastructure` failure boundary, then exposed a real auto-recharge race in `billing-activities.integration.test.ts`.
