...
`<domain>` uses [Effect](https://effect.website) as the backbone of the backend architecture. Effect provides dependency injection through services and layers, typed error handling, and composable program construction.
