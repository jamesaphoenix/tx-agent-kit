...
`<domain>` splits infrastructure into two layers: **shared services** managed by Docker Compose, and **application processes** run as local Node.js processes during development.
