---
name: "tx-core-loop"
description: "Work the main tx queue: initialize, create tasks, inspect work, claim tasks, and complete them. Use when working in Claude Code and the user needs tx commands from this area."
metadata:
