...
description: High-level architecture of the <domain> monorepo
---

`<domain>` is a pnpm monorepo organized into two top-level directories: `apps/` for deployable applications and `packages/` for shared libraries.
