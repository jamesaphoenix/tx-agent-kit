...
description: "Inspect queue health, diagnostics, dashboards, run traces, and recent failures. Use when working in Codex and the user needs tx commands from this area."
metadata:
