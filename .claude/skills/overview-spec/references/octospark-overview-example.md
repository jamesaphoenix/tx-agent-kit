...
tags:
  ...
  - product
  - example
plan: ~/.claude/plans/tx-agent-kit-product-requirements.md
---

# Plan

Plan file: [~/.claude/plans/tx-agent-kit-product-requirements.md](~/.claude/plans/tx-agent-kit-product-requirements.md)
