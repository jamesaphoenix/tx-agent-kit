...
ensure_key_if_missing ".env" "AUTH_SECRET" "$(openssl rand -hex 32)"
upsert_key ".env" "API_CORS_ORIGIN" "http://localhost:3000"
upsert_key ".env" "API_BASE_URL" "http://localhost:4000"
upsert_key ".env" "DEV_CLOUDFLARE_TUNNEL_ENABLED" "false"
upsert_key ".env" "DEV_CLOUDFLARE_TUNNEL_LOG_FILE" ".data/cloudflared/dev-tunnel.log"
upsert_key ".env" "DEV_CLOUDFLARE_TUNNEL_LOCK_DIR" "/tmp/tx-agent-kit-dev-tunnel.lock"
upsert_key ".env" "DEV_CLOUDFLARE_TUNNEL_STALE_TIMEOUT_SECONDS" "120"
upsert_key ".env" "DEV_CLOUDFLARE_TUNNEL_MISSING_PID_GRACE_SECONDS" "15"
ensure_key_if_missing ".env" "DEV_CLOUDFLARE_TUNNEL_URL"
ensure_key_if_missing ".env" "DEV_CLOUDFLARE_TUNNEL_TOKEN"
...
upsert_key ".env" "OTEL_EXPORTER_OTLP_ENDPOINT" "http://localhost:4320"
upsert_key ".env" "OTEL_LOGS_EXPORTER" "otlp"
upsert_key ".env" "LANGFUSE_ENABLED" "true"
upsert_key ".env" "LANGFUSE_BASE_URL" "http://localhost:3003"
upsert_key ".env" "LANGFUSE_HOST" "http://localhost:3003"
ensure_key_if_missing ".env" "LANGFUSE_PUBLIC_KEY" "pk-lf-00000000-0000-4000-8000-000000000000"
ensure_key_if_missing ".env" "LANGFUSE_SECRET_KEY" "sk-lf-00000000-0000-4000-8000-000000000000"
upsert_key ".env" "LANGFUSE_SAMPLE_RATE" "1"
upsert_key ".env" "LANGFUSE_LOG_LEVEL" "WARN"
ensure_key_if_missing ".env" "NEXT_PUBLIC_SENTRY_DSN"
ensure_key_if_missing ".env" "WORKER_SENTRY_DSN"
ensure_key_if_missing ".env" "EXPO_PUBLIC_SENTRY_DSN"
...
upsert_key ".env" "TX_STORAGE_MODE" "memory"
